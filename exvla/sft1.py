...
def parse_args():
    ...
    parser.add_argument("--model", type=str, default="qwen2.5_3b",
...
def train(model, processor, train_dataset, val_dataset=None, args=None, training_mode=1):
    ...
    if args and args.output_dir:
        ...
        output_dir = get_output_dirs("sft")["checkpoint_dir"]

    os.makedirs(output_dir, exist_ok=True)

    model_save_dir = f"./models/{args.runname}" if args and args.runname else get_output_dirs("sft")["model_dir"]
